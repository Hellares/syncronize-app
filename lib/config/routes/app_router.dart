...
import '../../features/solicitud_cotizacion/presentation/pages/mis_cotizaciones_page.dart';
...
import '../../features/venta/presentation/pages/registro_ventas_page.dart';
...
class AppRouter {
  ...
  late final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      // Avisos de plataforma (solo super admin; el backend valida el rol).
      GoRoute(
      ...
      GoRoute(
        path: '/empresa/reportes/registro-ventas',
        name: 'empresa-registro-ventas',
        builder: (context, state) => const RegistroVentasPage(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: '/empresa/caja/auditoria/:cajaId',
        name: 'empresa-caja-auditoria',
        builder: (context, state) => CajaAuditoriaPage(
          cajaId: state.pathParameters['cajaId']!,
        ),
      ),
      GoRoute(
        path: '/empresa/tesoreria',
        name: 'empresa-tesoreria-selector',
        builder: (context, state) {
          final empresaId = state.uri.queryParameters['empresaId'] ?? '';
      ...
      GoRoute(
        ...
        name: 'empresa-tesoreria',
        builder: (context, state) => TesoreriaPage(
          sedeId: state.pathParameters['sedeId']!,
        ),
      ),
      // Rutas de caja chica
      GoRoute(
      ...
      GoRoute(
        path: '/empresa/gastos-recurrentes/nuevo',
        name: 'empresa-gastos-recurrentes-nuevo',
        builder: (context, state) => const GastoRecurrenteFormPage(),
      ),
      GoRoute(
        path: '/empresa/gastos-recurrentes/:id',
        name: 'empresa-gastos-recurrentes-detail',
        builder: (context, state) =>
            GastoRecurrenteDetailPage(gastoId: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/empresa/gastos-recurrentes/:id/editar',
      ...
      // TODAS las cotizaciones dirigidas al cliente (respuestas a sus
      // solicitudes + directas de empresas que lo cotizaron con su DNI).
      GoRoute(
        path: '/mis-cotizaciones',
        name: 'mis-cotizaciones',
        builder: (context, state) => const MisCotizacionesPage(),
      ),
      GoRoute(
        path: '/mis-cotizaciones/:id',
        name: 'mis-cotizaciones-detail',
        builder: (context, state) {
          final id = state.pathParameters['id']!;
          return CotizacionClientePage(cotizacionId: id);
        },
      ),
      GoRoute(
