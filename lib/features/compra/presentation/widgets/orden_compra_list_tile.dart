...
class OrdenCompraListTile extends StatelessWidget {
  final OrdenCompra orden;
  final VoidCallback? onTap;

  const OrdenCompraListTile({
    super.key,
    required this.orden,
    this.onTap,
  });
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Text(
                    DateFormatter.formatDate(orden.fechaEmision),
                    style: TextStyle(
                      fontSize: 10,
                      color: Colors.grey.shade700,
                      fontFamily:
  ...
  Widget _buildFooter() {
    ...
    return Row(
      children: [
        // Monto total
        Text(
          '${orden.moneda} ${orden.total.toStringAsFixed(2)}',
