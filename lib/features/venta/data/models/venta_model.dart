...
VentaDeliveryData? _deliveryFromJson(Map<String, dynamic> json) {
  ...
  return VentaDeliveryData(
    ...
    costoSugerido: json['costoSugerido'] is num
        ? (json['costoSugerido'] as num).toDouble()
        : double.tryParse(json['costoSugerido']?.toString() ?? ''),
...
class VentaModel extends Venta {
  ...
  factory VentaModel.fromJson(Map<String, dynamic> json) {
    ...
    return VentaModel(
      ...
      comprobanteGratuitas: _tryParseDouble(json['comprobante'], 'gratuitas'),
