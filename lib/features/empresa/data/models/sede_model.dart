...
class SedeModel extends Sede {
  const SedeModel({
    ...
    required super.serieNotaCreditoBoleta,
    required super.serieNotaDebito,
    required super.serieNotaDebitoBoleta,
    super.serieGuiaRemision,
    super.rucSede,
    super.razonSocialSede,
    super.direccionFiscalSede,
    super.proveedorRuta,
    ...
    required super.ultimoNumeroNotaCreditoBoleta,
    required super.ultimoNumeroNotaDebito,
    required super.ultimoNumeroNotaDebitoBoleta,
  ...
  factory SedeModel.fromJson(Map<String, dynamic> json) {
    return SedeModel(
      ...
      serieNotaCredito: json['serieNotaCredito'] as String? ?? 'FC01',
      serieNotaCreditoBoleta: json['serieNotaCreditoBoleta'] as String? ?? 'BC01',
      serieNotaDebito: json['serieNotaDebito'] as String? ?? 'FD01',
      serieNotaDebitoBoleta: json['serieNotaDebitoBoleta'] as String? ?? 'BD01',
      serieGuiaRemision: json['serieGuiaRemision'] as String?,
      rucSede: json['rucSede'] as String?,
      razonSocialSede: json['razonSocialSede'] as String?,
      direccionFiscalSede: json['direccionFiscalSede'] as String?,
      proveedorRuta: json['proveedorRuta'] as String?,
      proveedorToken: json['proveedorToken'] as String?,
      facturacionActiva: json['facturacionActiva'] as bool?,
      ...
      ultimoNumeroNotaCreditoBoleta: json['ultimoNumeroNotaCreditoBoleta'] as int? ?? 0,
      ultimoNumeroNotaDebito: json['ultimoNumeroNotaDebito'] as int? ?? 0,
      ultimoNumeroNotaDebitoBoleta: json['ultimoNumeroNotaDebitoBoleta'] as int? ?? 0,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'ultimoNumeroNotaCreditoBoleta': ultimoNumeroNotaCreditoBoleta,
      'ultimoNumeroNotaDebito': ultimoNumeroNotaDebito,
      'ultimoNumeroNotaDebitoBoleta': ultimoNumeroNotaDebitoBoleta,
  ...
  factory SedeModel.fromEntity(Sede entity) {
    return SedeModel(
      ...
      serieNotaCreditoBoleta: entity.serieNotaCreditoBoleta,
      serieNotaDebito: entity.serieNotaDebito,
      serieNotaDebitoBoleta: entity.serieNotaDebitoBoleta,
      ...
      ultimoNumeroNotaCreditoBoleta: entity.ultimoNumeroNotaCreditoBoleta,
      ultimoNumeroNotaDebito: entity.ultimoNumeroNotaDebito,
      ultimoNumeroNotaDebitoBoleta: entity.ultimoNumeroNotaDebitoBoleta,
  ...
  Map<String, dynamic> toCreateJson() {
    return {
      ...
      if (stand != null && stand!.isNotEmpty) 'stand': stand,
      ...
      if (serieNotaCreditoBoleta.isNotEmpty)
        'serieNotaCreditoBoleta': serieNotaCreditoBoleta,
      if (serieNotaDebito.isNotEmpty) 'serieNotaDebito': serieNotaDebito,
      if (serieNotaDebitoBoleta.isNotEmpty)
        'serieNotaDebitoBoleta': serieNotaDebitoBoleta,
