...
class EmpresaInfoModel extends EmpresaInfo {
  const EmpresaInfoModel({
    ...
    super.razonSocial,
    super.rubro,
    super.tipoContribuyente,
    super.estadoContribuyente,
    super.condicionContribuyente,
  ...
  factory EmpresaInfoModel.fromJson(Map<String, dynamic> json) {
    return EmpresaInfoModel(
      ...
      tipoContribuyente: json['tipoContribuyente'] as String?,
      estadoContribuyente: json['estadoContribuyente'] as String?,
      condicionContribuyente: json['condicionContribuyente'] as String?,
  ...
  factory EmpresaInfoModel.fromEntity(EmpresaInfo entity) {
    return EmpresaInfoModel(
      ...
      estadoContribuyente: entity.estadoContribuyente,
      condicionContribuyente: entity.condicionContribuyente,
