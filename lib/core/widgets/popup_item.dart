...
// /// 1) Enum para evitar strings mágicos
// enum ActionMenuType { edit, delete, share, disable }

// /// 2) Modelo PRO del item
...
//   /// confirmación opcional (ideal para delete)
...
//   /// acción directa por item (opcional)
...
// /// 3) Widget PRO reutilizable
// class ActionPopupMenuPro extends StatelessWidget {
//   final List<ActionMenuItem> items;

//   /// callback global cuando se selecciona algo
...
//         ),
//       ),
//       child: PopupMenuButton<ActionMenuType>(
//         icon: Icon(menuIcon, size: iconSize, color: iconColor ?? Colors.grey[600]),
//         padding: padding,
//         itemBuilder: (context) {
//           final List<PopupMenuEntry<ActionMenuType>> entries = [];

//           for (int i = 0; i < items.length; i++) {
//             final item = items[i];

//             entries.add(
//               PopupMenuItem<ActionMenuType>(
//                 value: item.type,
...
//                     child: Row(
//                       children: [
//                         Icon(item.icon, size: itemIconSize, color: item.color),
...
//             // divider entre items (si no es el último)
...
//           final item = items.firstWhere((e) => e.type == type);

//           // si está deshabilitado no hace nada (por seguridad)
